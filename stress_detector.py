...
predictor = dlib.shape_predictor(
    "/Users/kushagra/Downloads/shape_predictor_68_face_landmarks.dat")
emotion_classifier = load_model(
    "/Users/kushagra/Downloads/_mini_XCEPTION.102-0.66.hdf5", compile=False)
...
def get_frame(cap):
    while(True):
        ret, f = cap.read()
        f2 = cv2.flip(f, 1)
        frame = imutils.resize(f2, width=500, height=500)
